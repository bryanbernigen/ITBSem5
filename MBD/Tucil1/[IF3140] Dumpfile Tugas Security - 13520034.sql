...
--
-- Name: hampers; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.hampers AS
 SELECT e.firstname,
    e.lastname,
    o.addressline1
   FROM (public.employees e
     JOIN public.offices o ON (((o.officecode)::text = (e.officecode)::text)));


ALTER TABLE public.hampers OWNER TO postgres;
...
--
-- Name: jumlah_produk_terjual; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.jumlah_produk_terjual AS
 SELECT p.productname,
    p.productcode,
    sum(od.quantityordered) AS sum
   FROM (public.products p
     JOIN public.orderdetails od ON (((p.productcode)::text = (od.productcode)::text)))
  GROUP BY p.productname, p.productcode;


ALTER TABLE public.jumlah_produk_terjual OWNER TO postgres;
...
--
-- Name: kebutuhan_kurir; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.kebutuhan_kurir AS
 SELECT o.ordernumber,
   ...
   FROM (public.customers c
     JOIN public.orders o ON ((o.customernumber = c.customernumber)));


ALTER TABLE public.kebutuhan_kurir OWNER TO postgres;
...
--
-- Name: payment_21_sept; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.payment_21_sept AS
 SELECT p.customernumber,
    p.checknumber,
    p.paymentdate,
    p.amount
   FROM public.payments p
  WHERE (p.paymentdate >= '2021-09-01'::date);


ALTER TABLE public.payment_21_sept OWNER TO postgres;

--
-- Name: pelayanan_cabang; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_cabang AS
 SELECT e.lastname,
    e.firstname,
    c.customername,
    o.city
   FROM ((public.employees e
     JOIN public.customers c ON ((e.employeenumber = c.salesrepemployeenumber)))
     JOIN public.offices o ON (((o.officecode)::text = (e.officecode)::text)));


ALTER TABLE public.pelayanan_cabang OWNER TO postgres;

--
-- Name: pelayanan_boston; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_boston AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'Boston'::text);


ALTER TABLE public.pelayanan_boston OWNER TO postgres;

--
-- Name: pelayanan_london; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_london AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'London'::text);


ALTER TABLE public.pelayanan_london OWNER TO postgres;

--
-- Name: pelayanan_nyc; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_nyc AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'NYC'::text);


ALTER TABLE public.pelayanan_nyc OWNER TO postgres;

--
-- Name: pelayanan_paris; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_paris AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'Paris'::text);


ALTER TABLE public.pelayanan_paris OWNER TO postgres;

--
-- Name: pelayanan_sanfrancisco; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_sanfrancisco AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'San Francisco'::text);


ALTER TABLE public.pelayanan_sanfrancisco OWNER TO postgres;

--
-- Name: pelayanan_sydney; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_sydney AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'Sydney'::text);


ALTER TABLE public.pelayanan_sydney OWNER TO postgres;

--
-- Name: pelayanan_tokyo; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.pelayanan_tokyo AS
 SELECT pelayanan_cabang.lastname,
    pelayanan_cabang.firstname,
    pelayanan_cabang.customername
   FROM public.pelayanan_cabang
  WHERE ((pelayanan_cabang.city)::text ~~ 'Tokyo'::text);


ALTER TABLE public.pelayanan_tokyo OWNER TO postgres;
...
144	Volvo Model Replicas, Co	Berglund	Christina 	0921-12 3555	BerguvsvÃ¤gen  8	\N	LuleÃ¥	\N	S-958 22	Sweden	1504	53100.00
145	Danish Wholesale Imports	Petersen	Jytte 	31 12 3555	VinbÃ¦ltet 34	\N	Kobenhavn	\N	1734	Denmark	1401	83400.00
...
169	Porto Imports Co.	de Castro	Isabel 	(1) 356-5555	Estrada da saÃºde n. 58	\N	Lisboa	\N	1756	Portugal	\N	0.00
171	Daedalus Designs Imports	RancÃ©	Martine 	20.16.1555	184, chaussÃ©e de Tournai	\N	Lille	\N	59000	France	1370	82900.00
...
209	Mini Caravy	Citeaux	FrÃ©dÃ©rique 	88.60.1555	24, place KlÃ©ber	\N	Strasbourg	\N	67000	France	1370	53800.00
...
216	Enaco Distributors	Saavedra	Eduardo 	(93) 203 4555	Rambla de CataluÃ±a, 23	\N	Barcelona	\N	08022	Spain	1702	60300.00
219	Boards & Toys Co.	Young	Mary	3105552373	4097 Douglas Av.	\N	Glendale	CA	92561	USA	1166	11000.00
223	NatÃ¼rlich Autos	Kloss	Horst 	0372-555188	TaucherstraÃŸe 10	\N	Cunewalde	\N	01307	Germany	\N	0.00
227	Heintze Collectables	Ibsen	Palle	86 21 3555	Smagsloget 45	\N	Ã…rhus	\N	8200	Denmark	1401	120800.00
233	QuÃ©bec Home Shopping Network	FresniÃ¨re	Jean 	(514) 555-8054	43 rue St. Laurent	\N	MontrÃ©al	QuÃ©bec	H1J 1C3	Canada	1286	48700.00
237	ANG Resellers	Camino	Alejandra 	(91) 745 6555	Gran VÃ­a, 1	\N	Madrid	\N	28001	Spain	\N	0.00
...
256	Auto AssociÃ©s & Cie.	Tonini	Daniel 	30.59.8555	67, avenue de lEurope	\N	Versailles	\N	78000	France	1370	77900.00
259	Toms SpezialitÃ¤ten, Ltd	Pfalzheim	Henriette 	0221-5554327	Mehrheimerstr. 369	\N	KÃ¶ln	\N	50739	Germany	1504	120400.00
...
273	Franken Gifts, Co	Franken	Peter 	089-0877555	Berliner Platz 43	\N	MÃ¼nchen	\N	80805	Germany	\N	0.00
...
298	Vida Sport, Ltd	Holz	Mihael	0897-034555	Grenzacherweg 237	\N	GenÃ¨ve	\N	1203	Switzerland	1702	141300.00
...
335	Cramer SpezialitÃ¤ten, Ltd	Cramer	Philip 	0555-09555	Maubelstr. 90	\N	Brandenburg	\N	14776	Germany	\N	0.00
339	Classic Gift Ideas, Inc	Cervantes	Francisca	2155554695	782 First Street	\N	Philadelphia	PA	71270	USA	1188	81100.00
344	CAF Imports	Fernandez	Jesus	+34 913 728 555	Merchants House	27-30 Merchants Quay	Madrid	\N	28023	Spain	1702	59600.00
...
353	Reims Collectables	Henriot	Paul 	26.47.1555	59 rue de lAbbaye	\N	Reims	\N	51100	France	1337	81100.00
...
361	Kommission Auto	Josephs	Karin	0251-555259	Luisenstr. 48	\N	MÃ¼nster	\N	44087	Germany	\N	0.00
...
386	Lordine Souveniers	Moroni	Maurizio 	0522-556555	Strada Provinciale 124	\N	Reggio Emilia	\N	42100	Italy	1401	121400.00
...
409	Stuttgart Collectable Exchange	MÃ¼ller	Rita 	0711-555361	Adenauerallee 900	\N	Stuttgart	\N	70563	Germany	\N	0.00
...
448	Scandinavian Gift Ideas	Larsson	Martha	0695-34 6555	Ã…kergatan 24	\N	BrÃ¤cke	\N	S-844 67	Sweden	1504	116400.00
...
458	Corrida Auto Replicas, Ltd	Sommer	MartÃ­n 	(91) 555 22 82	C/ Araquil, 67	\N	Madrid	\N	28023	Spain	1702	104600.00
...
477	Mit VergnÃ¼gen & Co.	Moos	Hanna 	0621-08555	Forsterstr. 57	\N	Mannheim	\N	68306	Germany	\N	0.00
...
484	Iberia Gift Imports, Corp.	Roel	JosÃ© Pedro 	(95) 555 82 82	C/ Romero, 33	\N	Sevilla	\N	41101	Spain	1702	65700.00
...
496	Kellys Gift Shop	Snowden	Tony	+64 9 5555500	Arenales 1938 3A	\N	Auckland  	\N	\N	New Zealand	1612	110000.00
\.
...
10126	2019-05-28	2019-06-07	2019-06-02	Shipped	\N	458
10225	2020-02-22	2020-03-01	2020-02-24	Shipped	\N	298
10124	2019-05-21	2019-05-29	2019-05-25	Shipped	Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch	112
10127	2019-06-03	2019-06-09	2019-06-06	Shipped	Customer requested special shippment. The instructions were passed along to the warehouse	151
10128	2019-06-06	2019-06-12	2019-06-11	Shipped	\N	141
10129	2019-06-12	2019-06-18	2019-06-14	Shipped	\N	324
10130	2019-06-16	2019-06-24	2019-06-21	Shipped	\N	198
10131	2019-06-16	2019-06-25	2019-06-21	Shipped	\N	447
10132	2019-06-25	2019-07-01	2019-06-28	Shipped	\N	323
10133	2019-06-27	2019-07-04	2019-07-03	Shipped	\N	141
10134	2019-07-01	2019-07-10	2019-07-05	Shipped	\N	250
10135	2019-07-02	2019-07-12	2019-07-03	Shipped	\N	124
10136	2019-07-04	2019-07-14	2019-07-06	Shipped	Customer is interested in buying more Ferrari models	242
10137	2019-07-10	2019-07-20	2019-07-14	Shipped	\N	353
10138	2019-07-07	2019-07-16	2019-07-13	Shipped	\N	496
10139	2019-07-16	2019-07-23	2019-07-21	Shipped	\N	282
10140	2019-07-24	2019-08-02	2019-07-30	Shipped	\N	161
10141	2019-08-01	2019-08-09	2019-08-04	Shipped	\N	334
10142	2019-08-08	2019-08-16	2019-08-13	Shipped	\N	124
10143	2019-08-10	2019-08-18	2019-08-12	Shipped	Can we deliver the new Ford Mustang models by end-of-quarter?	320
10144	2019-08-13	2019-08-21	2019-08-14	Shipped	\N	381
10145	2019-08-25	2019-09-02	2019-08-31	Shipped	\N	205
10146	2019-09-03	2019-09-13	2019-09-06	Shipped	\N	447
10147	2019-09-05	2019-09-12	2019-09-09	Shipped	\N	379
10148	2019-09-11	2019-09-21	2019-09-15	Shipped	They want to reevaluate their terms agreement with Finance.	276
10149	2019-09-12	2019-09-18	2019-09-17	Shipped	\N	487
10150	2019-09-19	2019-09-27	2019-09-21	Shipped	They want to reevaluate their terms agreement with Finance.	148
10151	2019-09-21	2019-09-30	2019-09-24	Shipped	\N	311
10152	2019-09-25	2019-10-03	2019-10-01	Shipped	\N	333
10153	2019-09-28	2019-10-05	2019-10-03	Shipped	\N	141
10154	2019-10-02	2019-10-12	2019-10-08	Shipped	\N	219
10155	2019-10-06	2019-10-13	2019-10-07	Shipped	\N	186
10156	2019-10-08	2019-10-17	2019-10-11	Shipped	\N	141
10157	2019-10-09	2019-10-15	2019-10-14	Shipped	\N	473
10158	2019-10-10	2019-10-18	2019-10-15	Shipped	\N	121
10159	2019-10-10	2019-10-19	2019-10-16	Shipped	\N	321
10160	2019-10-11	2019-10-17	2019-10-17	Shipped	\N	347
10161	2019-10-17	2019-10-25	2019-10-20	Shipped	\N	227
10162	2019-10-18	2019-10-26	2019-10-19	Shipped	\N	321
10163	2019-10-20	2019-10-27	2019-10-24	Shipped	\N	424
10164	2019-10-21	2019-10-30	2019-10-23	Resolved	This order was disputed, but resolved on 11/1/2003; Customer doesnt like the colors and precision of the models.	452
10165	2019-10-22	2019-10-31	2019-12-26	Shipped	This order was on hold because customerss credit limit had been exceeded. Order will ship when payment is received	148
10166	2019-10-21	2019-10-30	2019-10-27	Shipped	\N	462
10167	2019-10-23	2019-10-30	\N	Cancelled	Customer called to cancel. The warehouse was notified in time and the order didnt ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.	448
10168	2019-10-28	2019-11-03	2019-11-01	Shipped	\N	161
10169	2019-11-04	2019-11-14	2019-11-09	Shipped	\N	276
10170	2019-11-04	2019-11-12	2019-11-07	Shipped	\N	452
10171	2019-11-05	2019-11-13	2019-11-07	Shipped	\N	233
10172	2019-11-05	2019-11-14	2019-11-11	Shipped	\N	175
10173	2019-11-05	2019-11-15	2019-11-09	Shipped	Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches	278
10174	2019-11-06	2019-11-15	2019-11-10	Shipped	\N	333
10175	2019-11-06	2019-11-14	2019-11-09	Shipped	\N	324
10176	2019-11-06	2019-11-15	2019-11-12	Shipped	\N	386
10177	2019-11-07	2019-11-17	2019-11-12	Shipped	\N	344
10178	2019-11-08	2019-11-16	2019-11-10	Shipped	Custom shipping instructions sent to warehouse	242
10379	2021-02-10	2021-02-18	2021-02-11	Shipped	\N	141
10380	2021-02-16	2021-02-24	2021-02-18	Shipped	\N	141
10179	2019-11-11	2019-11-17	2019-11-13	Cancelled	Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.	496
10180	2019-11-11	2019-11-19	2019-11-14	Shipped	\N	171
10181	2019-11-12	2019-11-19	2019-11-15	Shipped	\N	167
10182	2019-11-12	2019-11-21	2019-11-18	Shipped	\N	124
10183	2019-11-13	2019-11-22	2019-11-15	Shipped	We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.	339
10184	2019-11-14	2019-11-22	2019-11-20	Shipped	\N	484
10185	2019-11-14	2019-11-21	2019-11-20	Shipped	\N	320
10186	2019-11-14	2019-11-20	2019-11-18	Shipped	They want to reevaluate their terms agreement with the VP of Sales	489
10187	2019-11-15	2019-11-24	2019-11-16	Shipped	\N	211
10188	2019-11-18	2019-11-26	2019-11-24	Shipped	\N	167
10189	2019-11-18	2019-11-25	2019-11-24	Shipped	They want to reevaluate their terms agreement with Finance.	205
10190	2019-11-19	2019-11-29	2019-11-20	Shipped	\N	141
10191	2019-11-20	2019-11-30	2019-11-24	Shipped	We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.	259
10192	2019-11-20	2019-11-29	2019-11-25	Shipped	\N	363
10193	2019-11-21	2019-11-28	2019-11-27	Shipped	\N	471
10194	2019-11-25	2019-12-02	2019-11-26	Shipped	\N	146
10195	2019-11-25	2019-12-01	2019-11-28	Shipped	\N	319
10196	2019-11-26	2019-12-03	2019-12-01	Shipped	\N	455
10197	2019-11-26	2019-12-02	2019-12-01	Shipped	Customer inquired about remote controlled models and gold models.	216
10198	2019-11-27	2019-12-06	2019-12-03	Shipped	\N	385
10199	2019-12-01	2019-12-10	2019-12-06	Shipped	\N	475
10200	2019-12-01	2019-12-09	2019-12-06	Shipped	\N	211
10201	2019-12-01	2019-12-11	2019-12-02	Shipped	\N	129
10202	2019-12-02	2019-12-09	2019-12-06	Shipped	\N	357
10203	2019-12-02	2019-12-11	2019-12-07	Shipped	\N	141
10204	2019-12-02	2019-12-10	2019-12-04	Shipped	\N	151
10205	2019-12-03	2019-12-09	2019-12-07	Shipped	 I need all the information I can get on our competitors.	141
10206	2019-12-05	2019-12-13	2019-12-08	Shipped	Can we renegotiate this one?	202
10207	2019-12-09	2019-12-17	2019-12-11	Shipped	Check on availability.	495
10208	2020-01-02	2020-01-11	2020-01-04	Shipped	\N	146
10209	2020-01-09	2020-01-15	2020-01-12	Shipped	\N	347
10210	2020-01-12	2020-01-22	2020-01-20	Shipped	\N	177
10211	2020-01-15	2020-01-25	2020-01-18	Shipped	\N	406
10212	2020-01-16	2020-01-24	2020-01-18	Shipped	\N	141
10213	2020-01-22	2020-01-28	2020-01-27	Shipped	Difficult to negotiate with customer. We need more marketing materials	489
10214	2020-01-26	2020-02-04	2020-01-29	Shipped	\N	458
10215	2020-01-29	2020-02-08	2020-02-01	Shipped	Customer requested that FedEx Ground is used for this shipping	475
10216	2020-02-02	2020-02-10	2020-02-04	Shipped	\N	256
10217	2020-02-04	2020-02-14	2020-02-06	Shipped	\N	166
10218	2020-02-09	2020-02-16	2020-02-11	Shipped	Customer requested that ad materials (such as posters, pamphlets) be included in the shippment	473
10219	2020-02-10	2020-02-17	2020-02-12	Shipped	\N	487
10220	2020-02-12	2020-02-19	2020-02-16	Shipped	\N	189
10221	2020-02-18	2020-02-26	2020-02-19	Shipped	\N	314
10222	2020-02-19	2020-02-27	2020-02-20	Shipped	\N	239
10223	2020-02-20	2020-02-29	2020-02-24	Shipped	\N	114
10224	2020-02-21	2020-03-02	2020-02-26	Shipped	Customer has worked with some of our vendors in the past and is aware of their MSRP	171
10226	2020-02-26	2020-03-06	2020-03-02	Shipped	\N	239
10227	2020-03-02	2020-03-12	2020-03-08	Shipped	\N	146
10228	2020-03-10	2020-03-18	2020-03-13	Shipped	\N	173
10229	2020-03-11	2020-03-20	2020-03-12	Shipped	\N	124
10230	2020-03-15	2020-03-24	2020-03-20	Shipped	Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch	128
10231	2020-03-19	2020-03-26	2020-03-25	Shipped	\N	344
10232	2020-03-20	2020-03-30	2020-03-25	Shipped	\N	240
10233	2020-03-29	2020-04-04	2020-04-02	Shipped	Customer requested special shippment. The instructions were passed along to the warehouse	328
10234	2020-03-30	2020-04-05	2020-04-02	Shipped	\N	412
10235	2020-04-02	2020-04-12	2020-04-06	Shipped	\N	260
10236	2020-04-03	2020-04-11	2020-04-08	Shipped	\N	486
10237	2020-04-05	2020-04-12	2020-04-10	Shipped	\N	181
10238	2020-04-09	2020-04-16	2020-04-10	Shipped	\N	145
10239	2020-04-12	2020-04-21	2020-04-17	Shipped	\N	311
10240	2020-04-13	2020-04-20	2020-04-20	Shipped	\N	177
10241	2020-04-13	2020-04-20	2020-04-19	Shipped	\N	209
10242	2020-04-20	2020-04-28	2020-04-25	Shipped	Customer is interested in buying more Ferrari models	456
10243	2020-04-26	2020-05-03	2020-04-28	Shipped	\N	495
10244	2020-04-29	2020-05-09	2020-05-04	Shipped	\N	141
10245	2020-05-04	2020-05-12	2020-05-09	Shipped	\N	455
10246	2020-05-05	2020-05-13	2020-05-06	Shipped	\N	141
10247	2020-05-05	2020-05-11	2020-05-08	Shipped	\N	334
10248	2020-05-07	2020-05-14	\N	Cancelled	Order was mistakenly placed. The warehouse noticed the lack of documentation.	131
10249	2020-05-08	2020-05-17	2020-05-11	Shipped	Can we deliver the new Ford Mustang models by end-of-quarter?	173
10250	2020-05-11	2020-05-19	2020-05-15	Shipped	\N	450
10251	2020-05-18	2020-05-24	2020-05-24	Shipped	\N	328
10252	2020-05-26	2020-06-04	2020-05-29	Shipped	\N	406
10348	2020-11-01	2020-11-08	2020-11-05	Shipped	\N	458
10349	2020-12-01	2020-12-07	2020-12-03	Shipped	\N	151
10350	2020-12-02	2020-12-08	2020-12-05	Shipped	\N	141
10383	2021-02-22	2021-03-02	2021-02-25	Shipped	\N	141
10384	2021-02-23	2021-03-06	2021-02-27	Shipped	\N	321
10385	2021-02-28	2021-03-09	2021-03-01	Shipped	\N	124
10386	2021-03-01	2021-03-09	2021-03-06	Resolved	Disputed then Resolved on 3/15/2005. Customer doesnt like the craftsmaship of the models.	141
10387	2021-03-02	2021-03-09	2021-03-06	Shipped	We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.	148
10388	2021-03-03	2021-03-11	2021-03-09	Shipped	\N	462
10389	2021-03-03	2021-03-09	2021-03-08	Shipped	\N	448
10390	2021-03-04	2021-03-11	2021-03-07	Shipped	They want to reevaluate their terms agreement with Finance.	124
10391	2021-03-09	2021-03-20	2021-03-15	Shipped	\N	276
10392	2021-03-10	2021-03-18	2021-03-12	Shipped	\N	452
10393	2021-03-11	2021-03-22	2021-03-14	Shipped	They want to reevaluate their terms agreement with Finance.	323
10394	2021-03-15	2021-03-25	2021-03-19	Shipped	\N	141
10395	2021-03-17	2021-03-24	2021-03-23	Shipped	We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.	250
10396	2021-03-23	2021-04-02	2021-03-28	Shipped	\N	124
10397	2021-03-28	2021-04-09	2021-04-01	Shipped	\N	242
10398	2021-03-30	2021-04-09	2021-03-31	Shipped	\N	353
10399	2021-04-01	2021-04-12	2021-04-03	Shipped	\N	496
10400	2021-04-01	2021-04-11	2021-04-04	Shipped	Customer requested that DHL is used for this shipping	450
10401	2021-04-03	2021-04-14	\N	On Hold	Customer credit limit exceeded. Will ship when a payment is received.	328
10402	2021-04-07	2021-04-14	2021-04-12	Shipped	\N	406
10403	2021-04-08	2021-04-18	2021-04-11	Shipped	\N	201
10404	2021-04-08	2021-04-14	2021-04-11	Shipped	\N	323
10405	2021-04-14	2021-04-24	2021-04-20	Shipped	\N	209
10406	2021-04-15	2021-04-25	2021-04-21	Disputed	Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.	145
10407	2021-04-22	2021-05-04	\N	On Hold	Customer credit limit exceeded. Will ship when a payment is received.	450
10408	2021-04-22	2021-04-29	2021-04-27	Shipped	\N	398
10409	2021-04-23	2021-05-05	2021-04-24	Shipped	\N	166
10410	2021-04-29	2021-05-10	2021-04-30	Shipped	\N	357
10411	2021-05-01	2021-05-08	2021-05-06	Shipped	\N	233
10412	2021-05-03	2021-05-13	2021-05-05	Shipped	\N	141
10413	2021-05-05	2021-05-14	2021-05-09	Shipped	Customer requested that DHL is used for this shipping	175
10414	2021-05-06	2021-05-13	\N	On Hold	Customer credit limit exceeded. Will ship when a payment is received.	362
10415	2021-05-09	2021-05-20	2021-05-12	Disputed	Customer claims the scales of the models dont match what was discussed. I keep all the paperwork though to prove otherwise	471
10416	2021-05-10	2021-05-16	2021-05-14	Shipped	\N	386
10417	2021-05-13	2021-05-19	2021-05-19	Disputed	Customer doesnt like the colors and precision of the models.	141
10418	2021-05-16	2021-05-24	2021-05-20	Shipped	\N	412
10419	2021-05-17	2021-05-28	2021-05-19	Shipped	\N	382
10420	2021-05-29	2021-06-07	\N	In Process	\N	282
10421	2021-05-29	2021-06-06	\N	In Process	Custom shipping instructions were sent to warehouse	124
10422	2021-05-30	2021-06-11	\N	In Process	\N	157
10253	2020-06-01	2020-06-09	2020-06-02	Cancelled	Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.	201
10254	2020-06-03	2020-06-13	2020-06-04	Shipped	Customer requested that DHL is used for this shipping	323
10255	2020-06-04	2020-06-12	2020-06-09	Shipped	\N	209
10256	2020-06-08	2020-06-16	2020-06-10	Shipped	\N	145
10257	2020-06-14	2020-06-24	2020-06-15	Shipped	\N	450
10258	2020-06-15	2020-06-25	2020-06-23	Shipped	\N	398
10259	2020-06-15	2020-06-22	2020-06-17	Shipped	\N	166
10260	2020-06-16	2020-06-22	\N	Cancelled	Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.	357
10261	2020-06-17	2020-06-25	2020-06-22	Shipped	\N	233
10262	2020-06-24	2020-07-01	\N	Cancelled	This customer found a better offer from one of our competitors. Will call back to renegotiate.	141
10263	2020-06-28	2020-07-04	2020-07-02	Shipped	\N	175
10264	2020-06-30	2020-07-06	2020-07-01	Shipped	Customer will send a truck to our local warehouse on 7/1/2004	362
10265	2020-07-02	2020-07-09	2020-07-07	Shipped	\N	471
10266	2020-07-06	2020-07-14	2020-07-10	Shipped	\N	386
10267	2020-07-07	2020-07-17	2020-07-09	Shipped	\N	151
10268	2020-07-12	2020-07-18	2020-07-14	Shipped	\N	412
10269	2020-07-16	2020-07-22	2020-07-18	Shipped	\N	382
10270	2020-07-19	2020-07-27	2020-07-24	Shipped	Can we renegotiate this one?	282
10271	2020-07-20	2020-07-29	2020-07-23	Shipped	\N	124
10272	2020-07-20	2020-07-26	2020-07-22	Shipped	\N	157
10273	2020-07-21	2020-07-28	2020-07-22	Shipped	\N	314
10274	2020-07-21	2020-07-29	2020-07-22	Shipped	\N	379
10275	2020-07-23	2020-08-02	2020-07-29	Shipped	\N	119
10276	2020-08-02	2020-08-11	2020-08-08	Shipped	\N	204
10277	2020-08-04	2020-08-12	2020-08-05	Shipped	\N	148
10278	2020-08-06	2020-08-16	2020-08-09	Shipped	\N	112
10381	2021-02-17	2021-02-25	2021-02-18	Shipped	\N	321
10382	2021-02-17	2021-02-23	2021-02-18	Shipped	Custom shipping instructions sent to warehouse	124
10279	2020-08-09	2020-08-19	2020-08-15	Shipped	Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches	141
10280	2020-08-17	2020-08-27	2020-08-19	Shipped	\N	249
10281	2020-08-19	2020-08-28	2020-08-23	Shipped	\N	157
10282	2020-08-20	2020-08-26	2020-08-22	Shipped	\N	124
10283	2020-08-20	2020-08-30	2020-08-23	Shipped	\N	260
10284	2020-08-21	2020-08-29	2020-08-26	Shipped	Custom shipping instructions sent to warehouse	299
10285	2020-08-27	2020-09-04	2020-08-31	Shipped	\N	286
10286	2020-08-28	2020-09-06	2020-09-01	Shipped	\N	172
10287	2020-08-30	2020-09-06	2020-09-01	Shipped	\N	298
10288	2020-09-01	2020-09-11	2020-09-05	Shipped	\N	166
10289	2020-09-03	2020-09-13	2020-09-04	Shipped	We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.	167
10290	2020-09-07	2020-09-15	2020-09-13	Shipped	\N	198
10291	2020-09-08	2020-09-17	2020-09-14	Shipped	\N	448
10292	2020-09-08	2020-09-18	2020-09-11	Shipped	They want to reevaluate their terms agreement with Finance.	131
10293	2020-09-09	2020-09-18	2020-09-14	Shipped	\N	249
10294	2020-09-10	2020-09-17	2020-09-14	Shipped	\N	204
10295	2020-09-10	2020-09-17	2020-09-14	Shipped	They want to reevaluate their terms agreement with Finance.	362
10296	2020-09-15	2020-09-22	2020-09-16	Shipped	\N	415
10297	2020-09-16	2020-09-22	2020-09-21	Shipped	We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.	189
10298	2020-09-27	2020-10-05	2020-10-01	Shipped	\N	103
10299	2020-09-30	2020-10-10	2020-10-01	Shipped	\N	186
10300	2019-10-04	2019-10-13	2019-10-09	Shipped	\N	128
10301	2019-10-05	2019-10-15	2019-10-08	Shipped	\N	299
10302	2019-10-06	2019-10-16	2019-10-07	Shipped	\N	201
10303	2020-10-06	2020-10-14	2020-10-09	Shipped	Customer inquired about remote controlled models and gold models.	484
10304	2020-10-11	2020-10-20	2020-10-17	Shipped	\N	256
10305	2020-10-13	2020-10-22	2020-10-15	Shipped	Check on availability.	286
10306	2020-10-14	2020-10-21	2020-10-17	Shipped	\N	187
10307	2020-10-14	2020-10-23	2020-10-20	Shipped	\N	339
10308	2020-10-15	2020-10-24	2020-10-20	Shipped	Customer requested that FedEx Ground is used for this shipping	319
10309	2020-10-15	2020-10-24	2020-10-18	Shipped	\N	121
10310	2020-10-16	2020-10-24	2020-10-18	Shipped	\N	259
10311	2020-10-16	2020-10-23	2020-10-20	Shipped	Difficult to negotiate with customer. We need more marketing materials	141
10312	2020-10-21	2020-10-27	2020-10-23	Shipped	\N	124
10313	2020-10-22	2020-10-28	2020-10-25	Shipped	Customer requested that FedEx Ground is used for this shipping	202
10314	2020-10-22	2020-11-01	2020-10-23	Shipped	\N	227
10315	2020-10-29	2020-11-08	2020-10-30	Shipped	\N	119
10316	2020-11-01	2020-11-09	2020-11-07	Shipped	Customer requested that ad materials (such as posters, pamphlets) be included in the shippment	240
10317	2020-11-02	2020-11-12	2020-11-08	Shipped	\N	161
10318	2020-11-02	2020-11-09	2020-11-07	Shipped	\N	157
10319	2020-11-03	2020-11-11	2020-11-06	Shipped	Customer requested that DHL is used for this shipping	456
10320	2020-11-03	2020-11-13	2020-11-07	Shipped	\N	144
10321	2020-11-04	2020-11-12	2020-11-07	Shipped	\N	462
10322	2020-11-04	2020-11-12	2020-11-10	Shipped	Customer has worked with some of our vendors in the past and is aware of their MSRP	363
10323	2020-11-05	2020-11-12	2020-11-09	Shipped	\N	128
10324	2020-11-05	2020-11-11	2020-11-08	Shipped	\N	181
10325	2020-11-05	2020-11-13	2020-11-08	Shipped	\N	121
10326	2020-11-09	2020-11-16	2020-11-10	Shipped	\N	144
10327	2020-11-10	2020-11-19	2020-11-13	Resolved	Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models dont match what was discussed.	145
10328	2020-11-12	2020-11-21	2020-11-18	Shipped	Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch	278
10329	2020-11-15	2020-11-24	2020-11-16	Shipped	\N	131
10330	2020-11-16	2020-11-25	2020-11-21	Shipped	\N	385
10331	2020-11-17	2020-11-23	2020-11-23	Shipped	Customer requested special shippment. The instructions were passed along to the warehouse	486
10332	2020-11-17	2020-11-25	2020-11-18	Shipped	\N	187
10333	2020-11-18	2020-11-27	2020-11-20	Shipped	\N	129
10334	2020-11-19	2020-11-28	\N	On Hold	The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.	144
10335	2020-11-19	2020-11-29	2020-11-23	Shipped	\N	124
10336	2020-11-20	2020-11-26	2020-11-24	Shipped	Customer requested that DHL is used for this shipping	172
10337	2020-11-21	2020-11-30	2020-11-26	Shipped	\N	424
10338	2020-11-22	2020-12-02	2020-11-27	Shipped	\N	381
10339	2020-11-23	2020-11-30	2020-11-30	Shipped	\N	398
10340	2020-11-24	2020-12-01	2020-11-25	Shipped	Customer is interested in buying more Ferrari models	216
10341	2020-11-24	2020-12-01	2020-11-29	Shipped	\N	382
10342	2020-11-24	2020-12-01	2020-11-29	Shipped	\N	114
10343	2020-11-24	2020-12-01	2020-11-26	Shipped	\N	353
10344	2020-11-25	2020-12-02	2020-11-29	Shipped	\N	350
10345	2020-11-25	2020-12-01	2020-11-26	Shipped	\N	103
10346	2020-11-29	2020-12-05	2020-11-30	Shipped	\N	112
10347	2020-11-29	2020-12-07	2020-11-30	Shipped	Can we deliver the new Ford Mustang models by end-of-quarter?	114
10351	2020-12-03	2020-12-11	2020-12-07	Shipped	\N	324
10352	2020-12-03	2020-12-12	2020-12-09	Shipped	\N	198
10353	2020-12-04	2020-12-11	2020-12-05	Shipped	\N	447
10354	2020-12-04	2020-12-10	2020-12-05	Shipped	\N	323
10355	2020-12-07	2020-12-14	2020-12-13	Shipped	\N	141
10356	2020-12-09	2020-12-15	2020-12-12	Shipped	\N	250
10357	2020-12-10	2020-12-16	2020-12-14	Shipped	\N	124
10358	2020-12-10	2020-12-16	2020-12-16	Shipped	Customer requested that DHL is used for this shipping	141
10359	2020-12-15	2020-12-23	2020-12-18	Shipped	\N	353
10360	2020-12-16	2020-12-22	2020-12-18	Shipped	\N	496
10361	2020-12-17	2020-12-24	2020-12-20	Shipped	\N	282
10362	2021-01-05	2021-01-16	2021-01-10	Shipped	\N	161
10363	2021-01-06	2021-01-12	2021-01-10	Shipped	\N	334
10364	2021-01-06	2021-01-17	2021-01-09	Shipped	\N	350
10365	2021-01-07	2021-01-18	2021-01-11	Shipped	\N	320
10366	2021-01-10	2021-01-19	2021-01-12	Shipped	\N	381
10367	2021-01-12	2021-01-21	2021-01-16	Resolved	This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedExs investigation proved this wrong.	205
10368	2021-01-19	2021-01-27	2021-01-24	Shipped	Can we renegotiate this one?	124
10369	2021-01-20	2021-01-28	2021-01-24	Shipped	\N	379
10370	2021-01-20	2021-02-01	2021-01-25	Shipped	\N	276
10371	2021-01-23	2021-02-03	2021-01-25	Shipped	\N	124
10372	2021-01-26	2021-02-05	2021-01-28	Shipped	\N	398
10373	2021-01-31	2021-02-08	2021-02-06	Shipped	\N	311
10374	2021-02-02	2021-02-09	2021-02-03	Shipped	\N	333
10375	2021-02-03	2021-02-10	2021-02-06	Shipped	\N	119
10376	2021-02-08	2021-02-18	2021-02-13	Shipped	\N	219
10377	2021-02-09	2021-02-21	2021-02-12	Shipped	Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches	186
10378	2021-02-10	2021-02-18	2021-02-11	Shipped	\N	141
10100	2019-01-06	2019-01-13	2019-01-10	Shipped	\N	363
10101	2019-01-09	2019-01-18	2019-01-11	Shipped	Check on availability.	128
10102	2019-01-10	2019-01-18	2019-01-14	Shipped	\N	181
10103	2019-01-29	2019-02-07	2019-02-02	Shipped	\N	121
10104	2019-01-31	2019-02-09	2019-02-01	Shipped	\N	141
10105	2019-02-11	2019-02-21	2019-02-12	Shipped	\N	145
10106	2019-02-17	2019-02-24	2019-02-21	Shipped	\N	278
10107	2019-02-24	2019-03-03	2019-02-26	Shipped	Difficult to negotiate with customer. We need more marketing materials	131
10108	2019-03-03	2019-03-12	2019-03-08	Shipped	\N	385
10109	2019-03-10	2019-03-19	2019-03-11	Shipped	Customer requested that FedEx Ground is used for this shipping	486
10110	2019-03-18	2019-03-24	2019-03-20	Shipped	\N	187
10111	2019-03-25	2019-03-31	2019-03-30	Shipped	\N	129
10112	2019-03-24	2019-04-03	2019-03-29	Shipped	Customer requested that ad materials (such as posters, pamphlets) be included in the shippment	144
10113	2019-03-26	2019-04-02	2019-03-27	Shipped	\N	124
10114	2019-04-01	2019-04-07	2019-04-02	Shipped	\N	172
10115	2019-04-04	2019-04-12	2019-04-07	Shipped	\N	424
10116	2019-04-11	2019-04-19	2019-04-13	Shipped	\N	381
10117	2019-04-16	2019-04-24	2019-04-17	Shipped	\N	148
10118	2019-04-21	2019-04-29	2019-04-26	Shipped	Customer has worked with some of our vendors in the past and is aware of their MSRP	216
386	HG438769	2020-07-18	51619.02
398	AJ478695	2021-02-14	33967.73
398	DO787644	2020-06-21	22037.91
398	JPMR4544	2021-05-18	615.45
398	KB54275	2020-11-29	48927.64
406	BJMPR4545	2021-04-23	12190.85
406	HJ217687	2020-01-28	49165.16
406	NA197101	2020-06-17	25080.96
412	GH197075	2020-07-25	35034.57
412	PJ434867	2020-04-14	31670.37
415	ER54537	2020-09-28	31310.09
424	KF480160	2020-12-07	25505.98
424	LM271923	2019-04-16	21665.98
424	OA595449	2019-10-31	22042.37
447	AO757239	2019-09-15	6631.36
447	ER615123	2019-06-25	17032.29
447	OU516561	2020-12-17	26304.13
448	FS299615	2021-04-18	27966.54
448	KR822727	2020-09-30	48809.90
450	EF485824	2020-06-21	59551.38
452	ED473873	2019-11-15	27121.90
452	FN640986	2019-11-20	15130.97
452	HG635467	2021-05-03	8807.12
455	HA777606	2019-12-05	38139.18
455	IR662429	2020-05-12	32239.47
456	GJ715659	2020-11-13	27550.51
456	MO743231	2020-04-30	1679.92
458	DD995006	2020-11-15	33145.56
458	NA377824	2020-02-06	22162.61
458	OO606861	2019-06-13	57131.92
462	ED203908	2021-04-15	30293.77
462	GC60330	2019-11-08	9977.85
462	PE176846	2020-11-27	48355.87
471	AB661578	2020-07-28	9415.13
471	CO645196	2019-12-10	35505.63
473	LL427009	2020-02-17	7612.06
473	PC688499	2019-10-27	17746.26
475	JP113227	2019-12-09	7678.25
475	PB951268	2020-02-13	36070.47
484	GK294076	2020-10-26	3474.66
484	JH546765	2019-11-29	47513.19
486	BL66528	2020-04-14	5899.38
486	HS86661	2020-11-23	45994.07
486	JB117768	2019-03-20	25833.14
487	AH612904	2019-09-28	29997.09
487	PT550181	2020-02-29	12573.28
489	OC773849	2019-12-04	22275.73
489	PO860906	2020-01-31	7310.42
495	BH167026	2019-12-26	59265.14
495	FN155234	2020-05-14	6276.60
496	EU531600	2021-05-25	30253.75
496	MB342426	2019-07-16	32077.44
496	MN89921	2020-12-31	52166.00
\.
...
--
-- Name: customernumber; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: officecode; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: productcode; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: productline; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX productline ON public.products USING btree (productline);


--
-- Name: reportsto; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: salesrepemployeenumber; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: customers customers_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orderdetails orderdetails_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orderdetails orderdetails_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
GRANT SELECT ON TABLE public.customers TO business_intelligence;
...
GRANT SELECT,UPDATE ON TABLE public.employees TO employee_manager;


--
-- Name: TABLE hampers; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.hampers TO hrd;
...
GRANT SELECT ON TABLE public.orderdetails TO business_intelligence;
...
GRANT SELECT ON TABLE public.products TO business_intelligence;
GRANT SELECT,INSERT,UPDATE ON TABLE public.products TO procurement;


--
-- Name: TABLE jumlah_produk_terjual; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.jumlah_produk_terjual TO sales;
...
GRANT SELECT ON TABLE public.orders TO business_intelligence;
...
GRANT SELECT ON TABLE public.payments TO accountant;


--
-- Name: TABLE payment_21_sept; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_21_sept TO accountant;
